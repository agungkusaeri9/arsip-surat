	...
	<div class="section-body">
		<div class="row">
			<div class="col-md-12">
				<div class="card">
					<div class="card-body">
						<form action="<?= base_url('Disposisi/store/' . $id_surat_masuk) ?>" method="post">
							<div class="form-group">
								...
								<select name="id_klasifikasi" id="id_klasifikasi" class="form-control <?php if (form_error('id_klasifikasi')) : ?> is-invalid <?php endif; ?>">
									...
									<option value="<?= $klas->id_klasifikasi ?>"><?= $klas->nama . ' - ' . $klas->jabatan ?></option>
									<?php endforeach; ?>
								</select>
							...
							<div class="form-group">
								...
								<select name="id_sifat_surat" id="id_sifat_surat" class="form-control <?php if (form_error('id_sifat_surat')) : ?> is-invalid <?php endif; ?>">
									...
									<option value="<?= $sifat->id_sifat_surat ?>"><?= $sifat->sifat_surat ?></option>
									<?php endforeach; ?>
								</select>
							...
							<div class="form-group">
								...
								<textarea name="catatan" id="catatan" cols="30" rows="5"class="form-control <?php if (form_error('catatan')) : ?> is-invalid <?php endif; ?>"></textarea>
							...
							<div class="form-group">
								...
								<input id="batas_waktu" type="date" class="form-control <?php if (form_error('batas_waktu')) : ?> is-invalid <?php endif; ?>" name="batas_waktu" tabindex="1" >
