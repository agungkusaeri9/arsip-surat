						...
						<form action="" method="post">
							<div class="row">
								...
								<?php if($from_date || $to_date) : ?>
									<div class="col-md-1">
									<a href="<?= base_url('Surat_Keluar/print') ?>?from_date=<?= $from_date ?>&&to_date=<?= $to_date ?>" class="btn btn-block py-2 btn-danger mb-3"><i class="fas fa-print"></i> PDF</a>
									</div>
								<?php endif; ?>
								<?php if($from_date || $to_date) : ?>
									<div class="col-md-1">
									<a href="<?= base_url('Surat_Keluar/excel') ?>?from_date=<?= $from_date ?>&&to_date=<?= $to_date ?>" class="btn btn-block py-2 btn-info mb-3"><i class="fas fa-file-excel"></i> Excel</a>
									</div>
								<?php endif; ?>
							</div>
						</form>
