	...
	<div class="section-body">
		<div class="row">
			<div class="col-md-12">
				<div class="card">
					<div class="card-body">
						<form action="<?= base_url('Klasifikasi/store') ?>" method="post">
							...
							<div class="form-group">
								...
								<input id="jabatan" type="text" class="form-control <?php if (form_error('jabatan')) : ?> is-invalid <?php endif; ?>" name="jabatan" tabindex="1" autofocus>
